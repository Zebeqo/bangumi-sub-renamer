import {parseFilenames} from '../../src/utils/parser'
import {expect} from 'chai'

describe('Parse subtitle filename and video filename', () => {
  describe('example/[Moozzi2] Aoi Hana BD-BOX - TV + SP', () => {
    ...
    it('should get the data of the subtitle file name', () => {
      expect(
        parseFilenames(subFilesName, 'subtitle'),
      ).to.eql([
        {
          id: 1,
    ...
    it('should get the data of the video file name', () => {
      expect(
        parseFilenames(vidFilesName, 'video'),
      ).to.eql([
        {
          id: 1,
